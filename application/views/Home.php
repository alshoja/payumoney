    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table>
        ...
        <tr>
           ...
           <input type="hidden" name="surl" value="<?php echo base_url()?>HomeController/success " size="64" />
        
       
          
          <td colspan="3"><input  type="hidden" name="furl"value="<?php echo base_url()?>HomeController/failure" size="64" /></td>
          ...
          <?php if(!$hash) { ?>
            <td colspan="4"><input type="submit" value="Buy" /></td>
          <?php } ?>
        </tr>
      </table>
    </form>
